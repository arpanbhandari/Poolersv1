...
<html>
    ...
    <body style="background-image:url('http://www.esc.cam.ac.uk/esc/images/Department/library/Areas%20Mapped%20by%20Part%20II%20Earth%20Sciences%20Students,%20Cambridge%20-%20Google%20Maps%20-%20Googl_2012-10-10_10-49-24.png'); opacity:1.5; background-size: cover; background-repeat:repeat;">
        ...
        <div style="height:200px; width:300px; color:#999999; margin-top:200px; margin-left:auto; margin-right:auto; background-color:#101010;padding:5px; text-align:center;">
            <span style=""><b>Available Poolers:</b></span><br><br>
            <p><?php
                session_start();
             ...
             //   $result = mysqli_query($connect,"SELECT * from pool where source='$source' AND destination='$destination' AND date='$date' AND time='$time' ;" );
                $result = mysqli_query($connect,"SELECT * from pool where source='$source' AND destination='$destination' AND date='$date' AND ((time>subtime('$time','00:15:01')) and (time<addtime('$time','00:15:01')) ) ;" );
                $count=0;
        ...
        <br>
        <img src="img/car.gif" width="100" height="100" style="margin-left:150px;">
